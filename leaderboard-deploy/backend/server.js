...
const GAMBLE_CASES = [
  { id:'starter', name:'Starter Case', cost:50, emoji:'📦',
    ...
    goldenItems:[
      ...
      {name:'200 Points',points:200,weight:250,rarity:'gold'},
      {name:'500 Points',points:500,weight:150,rarity:'jackpot'},
      ...
      {name:'1,000 Points',points:1000,weight:9,rarity:'ultra'},
  ...
  { id:'premium', name:'Premium Case', cost:100, emoji:'🎁',
    ...
    goldenItems:[
      {name:'200 Points',points:200,weight:400,rarity:'gold'},
      {name:'400 Points',points:400,weight:250,rarity:'gold'},
      {name:'1,000 Points',points:1000,weight:140,rarity:'jackpot'},
      {name:'$10 Tip',...STORE_PRIZES.tip10,points:0,weight:100,rarity:'store'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:60,rarity:'store'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:30,rarity:'store'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:10,rarity:'store'},
      {name:'2,000 Points',points:2000,weight:9,rarity:'ultra'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:1,rarity:'ultra'},
    ]},
  { id:'elite', name:'Elite Case', cost:250, emoji:'💎',
    ...
    goldenItems:[
      {name:'500 Points',points:500,weight:400,rarity:'gold'},
      ...
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:50,rarity:'store'},
      {name:'2,500 Points',points:2500,weight:30,rarity:'jackpot'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:19,rarity:'store'},
      {name:'5,000 Points',points:5000,weight:1,rarity:'ultra'},
    ]},
  { id:'mega', name:'Mega Case', cost:500, emoji:'👑',
    ...
    goldenItems:[
      {name:'1,000 Points',points:1000,weight:390,rarity:'gold'},
      {name:'2,000 Points',points:2000,weight:240,rarity:'gold'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:120,rarity:'store'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:100,rarity:'store'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:80,rarity:'store'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:50,rarity:'store'},
      {name:'5,000 Points',points:5000,weight:18,rarity:'jackpot'},
      {name:'10,000 Points',points:10000,weight:2,rarity:'ultra'},
    ]},
];
