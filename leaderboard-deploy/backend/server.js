...
const GAMBLE_CASES = [
  { id:'starter', name:'Starter Case', cost:50, emoji:'📦',
    ...
    goldenItems:[
      {name:'100 Points',points:100,weight:350,rarity:'purple'},
      {name:'200 Points',points:200,weight:230,rarity:'purple'},
      {name:'400 Points',points:400,weight:160,rarity:'pink'},
      {name:'$10 Tip',...STORE_PRIZES.tip10,points:0,weight:130,rarity:'gold'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:80,rarity:'gold'},
      {name:'1,000 Points',points:1000,weight:40,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:10,rarity:'gold-ultra'},
    ]},
  { id:'premium', name:'Premium Case', cost:100, emoji:'🎁',
    ...
    goldenItems:[
      {name:'200 Points',points:200,weight:320,rarity:'purple'},
      {name:'400 Points',points:400,weight:220,rarity:'purple'},
      {name:'800 Points',points:800,weight:150,rarity:'pink'},
      {name:'$10 Tip',...STORE_PRIZES.tip10,points:0,weight:130,rarity:'gold'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:80,rarity:'gold'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:50,rarity:'gold'},
      {name:'2,000 Points',points:2000,weight:40,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:10,rarity:'gold-ultra'},
    ]},
  { id:'elite', name:'Elite Case', cost:250, emoji:'💎',
    ...
    goldenItems:[
      {name:'500 Points',points:500,weight:310,rarity:'purple'},
      {name:'1,000 Points',points:1000,weight:210,rarity:'purple'},
      {name:'2,000 Points',points:2000,weight:140,rarity:'pink'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:120,rarity:'gold'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:90,rarity:'gold'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:60,rarity:'gold'},
      {name:'5,000 Points',points:5000,weight:60,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:10,rarity:'gold-ultra'},
    ]},
  { id:'mega', name:'Mega Case', cost:500, emoji:'👑',
    ...
    goldenItems:[
      {name:'1,000 Points',points:1000,weight:300,rarity:'purple'},
      {name:'2,000 Points',points:2000,weight:200,rarity:'purple'},
      {name:'4,000 Points',points:4000,weight:140,rarity:'pink'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:130,rarity:'gold'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:100,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:60,rarity:'gold'},
      {name:'10,000 Points',points:10000,weight:60,rarity:'gold'},
      {name:'$100 Bonus Buy x2',...STORE_PRIZES.bonus100,points:0,weight:10,rarity:'gold-ultra'},
    ]},
];
