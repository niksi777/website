...
const GAMBLE_CASES = [
  { id:'starter', name:'Starter Case', cost:50, emoji:'📦',
    ...
    goldenItems:[
      {name:'100 Points',points:100,weight:400,rarity:'gold'},
      {name:'200 Points',points:200,weight:280,rarity:'gold'},
      {name:'500 Points',points:500,weight:160,rarity:'gold'},
      {name:'$10 Tip',...STORE_PRIZES.tip10,points:0,weight:100,rarity:'gold'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:50,rarity:'gold'},
      {name:'1,000 Points',points:1000,weight:9,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:1,rarity:'gold-ultra'},
    ]},
  { id:'premium', name:'Premium Case', cost:100, emoji:'🎁',
    ...
    goldenItems:[
      ...
      {name:'500 Points',points:500,weight:240,rarity:'gold'},
      {name:'$10 Tip',...STORE_PRIZES.tip10,points:0,weight:140,rarity:'gold'},
      ...
      {name:'2,000 Points',points:2000,weight:9,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:1,rarity:'gold-ultra'},
    ]},
  { id:'elite', name:'Elite Case', cost:250, emoji:'💎',
    ...
    goldenItems:[
      {name:'500 Points',points:500,weight:370,rarity:'gold'},
      {name:'1,000 Points',points:1000,weight:240,rarity:'gold'},
      {name:'$15 Tip',...STORE_PRIZES.tip15,points:0,weight:130,rarity:'gold'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:100,rarity:'gold'},
      {name:'$40 Bonus Buy',...STORE_PRIZES.bonus40,points:0,weight:60,rarity:'gold'},
      {name:'5,000 Points',points:5000,weight:9,rarity:'gold'},
      {name:'$100 Bonus Buy',...STORE_PRIZES.bonus100,points:0,weight:1,rarity:'gold-ultra'},
    ]},
  { id:'mega', name:'Mega Case', cost:500, emoji:'👑',
    ...
    goldenItems:[
      {name:'1,000 Points',points:1000,weight:360,rarity:'gold'},
      {name:'2,000 Points',points:2000,weight:240,rarity:'gold'},
      {name:'$20 Bonus Buy',...STORE_PRIZES.bonus20,points:0,weight:150,rarity:'gold'},
      ...
      {name:'10,000 Points',points:10000,weight:9,rarity:'gold'},
      {name:'$100 Bonus Buy x2',...STORE_PRIZES.bonus100,points:0,weight:1,rarity:'gold-ultra'},
    ]},
];
